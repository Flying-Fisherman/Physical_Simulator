	...
	<form action="<c:url value='/community/write_question_process' />" method="POST">
			<table class="table">
				...
				<tr>
					<th>題目</th>
					<td>
						<input type="text" name="title" placeholder="題目　入力" class="form-control"/>
					</td>
				</tr>
				...
				<tr>
					<th>内容</th>
					<td>
						<textarea name="content" placeholder="内容を入力してください。" style="resize: none;" class="form-control" rows="20"></textarea>
					</td>
				</tr>
			</table>
