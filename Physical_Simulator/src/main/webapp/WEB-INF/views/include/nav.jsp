		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li><a href="<c:url value='/simulator/simulator_main'/>" onclick='return checkID()'>実験 - Simulate</a></li>
					<li><a href="<c:url value='/simulator/simulator_HTU'/>" onclick='return checkID()'>説明 - How To Use</a></li>
					...
					<li class="dropdown"><a href="<c:url value='/fail'/>" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="<c:url value='/community/community_question'/>" onclick='return checkID()'>質問 - Question</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<c:if test="${sessionScope.userID != null}">
						<li style="padding-top: 10px;"><button type="button"
								class="btn btn-default btn-sm" onclick="failform()"
